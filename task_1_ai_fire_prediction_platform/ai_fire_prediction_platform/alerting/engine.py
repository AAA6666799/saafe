...
from ai_fire_prediction_platform.core.interfaces import PredictionResult, RiskAssessment
from ai_fire_prediction_platform.hardware.abstraction import SensorData
