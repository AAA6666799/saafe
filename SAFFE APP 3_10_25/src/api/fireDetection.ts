...
// Function to call Saafe model
export async function predictSaafeModel(payload: any): Promise<ModelPrediction> {
  try {
    const response = await fetch('/api/predict/saafe', {
      method: 'POST',
      headers: {
    ...
    console.error("Error calling Saafe model:", error);
    return {
      status: "error",
      model: "saafe",
      prediction: null,
...
// Function to call 18 Features model
export async function predictFeatures18Model(payload: any): Promise<ModelPrediction> {
  try {
    const response = await fetch('/api/predict/features18', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    console.error("Error calling 18 Features model:", error);
    return {
      status: "error",
      model: "features18",
      prediction: null,
...
// Function to call Kaggle Base model
export async function predictKaggleModel(payload: any): Promise<ModelPrediction> {
  try {
    const response = await fetch('/api/predict/kaggle', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    console.error("Error calling Kaggle model:", error);
    return {
      status: "error",
      model: "kaggle",
      prediction: null,
...
// Function to call TensorFlow enhanced model
export async function predictTensorFlowModel(payload: any): Promise<ModelPrediction> {
  try {
    const response = await fetch('/api/predict/tensorflow', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
    ...
    console.error("Error calling TensorFlow model:", error);
    return {
      status: "error",
      model: "tensorflow",
      prediction: null,
