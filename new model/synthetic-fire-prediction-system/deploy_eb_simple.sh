...
# Simplified Fire Detection Dashboard Deployment Script for Elastic Beanstalk
# This script deploys the Streamlit dashboard to AWS Elastic Beanstalk without VPC configuration

set -e  # Exit on any error

echo "🚀 Starting Fire Detection Dashboard Deployment to Elastic Beanstalk (Simple Version)..."
...
# Create environment and deploy (without VPC configuration)
