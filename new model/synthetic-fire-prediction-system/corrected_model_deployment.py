#!/usr/bin/env python3
"""
FLIR+SCD41 Fire Detection System - Corrected Model Deployment
This script deploys the trained XGBoost model with proper configuration.
"""
...
def deploy_model():
    """Deploy the trained model to SageMaker hosting services with correct configuration."""
    print("Deploying trained model with correct configuration...")
    ...
    model_name = f"flir-scd41-xgboost-model-corrected-{timestamp}"
    ...
    try:
        # Create model with correct XGBoost configuration
