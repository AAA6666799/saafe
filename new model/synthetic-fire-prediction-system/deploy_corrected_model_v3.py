#!/usr/bin/env python3
"""
Deploy the corrected FLIR+SCD41 fire detection model to a SageMaker endpoint (v3)
"""
...
def deploy_model():
    ...
    print("🚀 Deploying corrected FLIR+SCD41 fire detection model to SageMaker endpoint (v3)...")
    ...
    model_name = f'flir-scd41-fire-detection-corrected-v3-{timestamp}'
    endpoint_config_name = f'flir-scd41-fire-detection-corrected-v3-config-{timestamp}'
    endpoint_name = f'flir-scd41-fire-detection-corrected-v3-{timestamp}'
    ...
    try:
        ...
        model_response = sagemaker.create_model(
            ...
            PrimaryContainer={
                ...
                'Environment': {
                    'SAGEMAKER_PROGRAM': 'serve.py',  # Using serve.py
                    'SAGEMAKER_SUBMIT_DIRECTORY': 's3://fire-detection-training-691595239825/flir_scd41_training/code/corrected_code_v3.tar.gz'  # Using v3 package
                }
            },
        ...
        print(f"  Code Package URL: s3://fire-detection-training-691595239825/flir_scd41_training/code/corrected_code_v3.tar.gz")
...
def main():
    """Main function"""
    print("FLIR+SCD41 Fire Detection - Corrected Model Deployment (v3)")
    print("=" * 58)
