...
# Simple Fixed Fire Detection Dashboard Deployment Script for Elastic Beanstalk
# This script deploys the Streamlit dashboard to AWS Elastic Beanstalk with a simpler approach

set -e  # Exit on any error

echo "🚀 Starting Fire Detection Dashboard Deployment to Elastic Beanstalk (Simple Fixed Version)..."
