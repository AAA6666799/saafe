#!/usr/bin/env python3
"""
Simplified Training Pipeline for FLIR+SCD41 Fire Detection System

This script implements a simplified training pipeline with:
1. Enhanced synthetic data generation
2. Ensemble methods combining multiple algorithms
3. Preparation for AWS SageMaker deployment
"""
...
def main():
    ...
    print("🔥 FLIR+SCD41 Fire Detection System - Simplified Training Pipeline")
    print("=" * 70)
    ...
    try:
        ...
        df = data_generator.generate_enhanced_data(num_samples=5000)  # Reduced for faster execution
        ...
        print("\n" + "=" * 70)
        print("🎉 SIMPLIFIED TRAINING PIPELINE COMPLETED SUCCESSFULLY!")
        print("=" * 70)
        ...
        print("  • Ensemble of 3 different algorithms (Random Forest, Gradient Boosting, Logistic Regression)")
        print("  • Performance-based ensemble weighting")
        ...
        print(f"\n❌ Error during simplified training pipeline: {e}")
        import traceback
        traceback.print_exc()
        return 1
